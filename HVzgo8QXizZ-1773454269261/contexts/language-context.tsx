...
const translations = {
  en: {
    ...
    "about.bio2":
      "He has spoken at *UX and technology events*, co-organized *SAIAConf*, and teaches in the postgraduate programs of *Digital Business (UCEMA)* and *Cryptoeconomics (UNCUYO)*. He has led *product and marketing strategies* at *fintech companies*, driving *digital innovation* and *scalable growth* across LATAM.",
    "about.bio3":
